...
router.post("/:showId/seats/lock", acquireSeatLock);
router.post("/:showId/seats/refresh", refreshSeatLock);
router.post("/:showId/seats/release", releaseSeatLock);
router.get("/:showId/seats", getShowSeatAvailability);
